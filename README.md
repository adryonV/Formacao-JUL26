# Formação JUL26 — Funil de Tráfego (Meta Ads · 100% na nuvem)
...
- URL pública: **https://adryonv.github.io/Formacao-JUL26/**
- Fonte 1 (anúncios, aba *Meta Ads*): planilha `1RM1jqe…` (gid 0)
- Fonte 2 (compradores, aba *A Formacao Jul 26*): planilha `1Qe1_LF…` (gid 769348486)
...
- **URL:** `https://api.github.com/repos/adryonV/Formacao-JUL26/dispatches`
- **Método:** `POST`
