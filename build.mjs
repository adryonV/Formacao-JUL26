...
const SHEET_ADS =
  'https://docs.google.com/spreadsheets/d/1RM1jqe_8aTRNLHBDMsTfzuJlbE1GGs2-blTpWbrOqwo/export?format=csv&gid=0';
// 2) Lista de Compradores — aba "A Formacao Jul 26" (gid 769348486)
const SHEET_SALES =
  'https://docs.google.com/spreadsheets/d/1Qe1_LFcrd98hhOTa5rJAL78ZRUoHCZ-Pj4kIRgdiljI/export?format=csv&gid=769348486';
